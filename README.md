...
Tyepscript Assignments for PIAIC Quarter 1 for advance students.
Each file is organized into Assignment(1-45) format.
...
# Commands
if you want to run each Assignment TS code, run "tsc main.ts" with having a correct Directory folder

if you want to run each Assignment JS code, run "node main.js" with having a correct Directory folder
