const user_name:String="ilyas khan";

// Following code converts the string into Lower case
console.log(`The Persons name in Lower case is: ${user_name.toLowerCase()}`);
// Following code converts the string into Upper case
console.log(`The Persons name in upper case is: ${user_name.toUpperCase()}`);
